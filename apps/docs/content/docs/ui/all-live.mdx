...
Ready to integrate JKT48 live data into your application?

<Cards>
  <Card href="/docs/api-reference" title="API Reference">
    Explore all available endpoints and their detailed documentation.
  </Card>
  <Card href="/docs/guides/authentication" title="Authentication Guide">
    Learn how to properly authenticate your API requests.
  </Card>
  <Card href="/docs/guides/rate-limits" title="Rate Limits">
