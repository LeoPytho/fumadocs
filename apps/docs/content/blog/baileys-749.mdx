...
```bash
# The fix addresses compatibility with Cheerio 1.0.0+
...
- **Compatibility Testing**: Verified across Node.js 16, 18, and 20
...
- **NPM Package**: https://www.npmjs.com/package/@jkt48connect-corp/baileys
...
> https://www.npmjs.com/package/@jkt48connect-corp/baileys
